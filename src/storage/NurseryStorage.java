...
public class NurseryStorage implements Storage{
    ...
    private void init(){
        ...
        dog.learnSkill(new Skill("Апорт"));
        ...
        horse.learnSkill(new Skill("Голос"));
        ...
        horse2.learnSkill(new Skill("Голос"));
        horse2.learnSkill(new Skill("Сидеть"));
        ...
        camel.learnSkill(new Skill("Сидеть"));
