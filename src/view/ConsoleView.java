...
public class ConsoleView implements View {
    ...
    public MainMenuCommand showMainMenuWithResult() {
        ...
        while (true) {
            try {
                ...
                printColorLine("Ошибка", RED_COLOR);
            }
        }
    }
    ...
    public boolean showAddAnimalDialog() {
        ...
        while (true) {
            ...
            try (counter){
                ...
                counter.add();
                return nurseryAccounting.createAnimal(parsedData.name, parsedData.birthDate, parsedData.animalGenus);
    ...
    private AnimalData parceAnimalData(String inputData) {
        ...
        AnimalGenus genius = AnimalGenus.valueOf(input[2].toUpperCase());
